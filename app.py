...
st.write("This application leverages Machine Learning to identify early signs of academic stress and burnout among campus students.")
...
grade = st.selectbox("Current Grade Level", options=[9, 10, 11, 12])
